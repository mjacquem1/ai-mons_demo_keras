...
for fn in list(os.walk('data'))[0][2]: # ['data/59590-640x360-overground-train_640.jpg', 'data/cat.jpg', 'data/dog.jpg', 'data/coffee.jpg', 'data/elephant.jpg']:
	img_path = os.path.join('data', fn)
	...
	cv2.putText(orig, "Label: {}, {:.2f}%".format(decoded[1][1], float(decoded[1][2])*100),
							(10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
	cv2.putText(orig, "Label: {}, {:.2f}%".format(decoded[2][1], float(decoded[2][2])*100),
